...
/**
 * @author Valdemar Karasevic
 */
public class LegalClientCalculator extends CommissionsCalculatorAbstract implements Runnable {

    private final Transaction transaction;
    private Cache cache = new Cache();
        
    public LegalClientCalculator(Transaction transaction, Cache cache) {
